// Credit: https://www.goodreads.com/quotes
const quotes = [{ quote: "I'm selfish, impatient and a little insecure. I make mistakes, I am out of control and at times hard to handle. But if you can't handle me at my worst, then you sure as hell don't deserve me at my best.", author: "Marilyn Monroe" },
...
const /** @type HTMLElement */ quote = document.querySelector("#quote span:first-child");
const /** @type HTMLElement */ author = document.querySelector("#quote span:last-child");
const /** @type HTMLElement */ quoteDiv = document.querySelector("div#quote");
const todaysQuote = quotes[Math.floor(Math.random() * quotes.length)];
quote.innerText = todaysQuote.quote;
quote.innerText += " - ";
author.innerText = todaysQuote.author;

quoteDiv.style.backgroundColor = "rgba(0,0,0,0.1)";
